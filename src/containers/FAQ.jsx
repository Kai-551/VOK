    ...
    <div id="faq" className="w-full mx-auto pt-20 pb-20">
        ...
        <Accordion>
            <AccordionItem className="mt-4 mb-8">
                ...
                <AccordionItemPanel>
                    <div className="rounded-lg text-black pl-12 pt-4 pb-4">
                        <p className="text-lg md:text-xl">Presale - $145</p>
                        <p className="text-lg md:text-xl">Public Sale - $175</p>
                        <p className=" text-lg md:text-xl">Price increases - $15 with every 100 Sold</p>
                    </div>
                </AccordionItemPanel>
            </AccordionItem>
            <AccordionItem className="mt-4 mb-8">
            ...
            <AccordionItem className="mt-4 mb-8">
                ...
                <AccordionItemPanel>
                    <div className=" rounded-lg text-black pl-12 pt-4 pb-4">
                        <p className="text-lg md:text-xl">1. Follow us on Twitter </p>
                        <p className="text-lg md:text-xl">2. Join the Whitelist games</p>
                        <p className="text-lg md:text-xl">3. Share and help gain the community more followers</p>
                        <p className="text-lg md:text-xl">4. Email us at <a href="mailto:KnightfallNFT@protonmail.com">KnightfallNFT@protonmail.com</a> with your information.</p>
                    </div>
                </AccordionItemPanel>
            </AccordionItem>
            <AccordionItem className="mt-4 mb-8">
                ...
                <AccordionItemPanel>
                    <div className=" rounded-lg text-black pl-12 pt-4 pb-4">
                        <p className="text-lg md:text-xl">1. Opensea</p>
                        <p className="text-lg md:text-xl">2. Etherum</p>
                        <p className="text-lg md:text-xl">3. ETH </p>
                    </div>
                </AccordionItemPanel>
            </AccordionItem>
            <AccordionItem className="mt-4 mb-8">
                ...
                <AccordionItemPanel>
                    <div className=" rounded-lg text-black pl-12 pt-4 pb-4">
                        <p className="text-lg md:text-xl">1. We will have the contract audited.</p>
                        <p className="text-lg md:text-xl">2. We will make sure the contract is gas friendly. </p>
                    </div>
                </AccordionItemPanel>
            </AccordionItem>
            <AccordionItem className="mt-4 mb-8">
                ...
                <AccordionItemPanel>
                    <div className=" rounded-lg text-black pl-12 pt-4 pb-4">
                        <p className="text-lg md:text-xl">2 per whitelist spot , we are also going to try and keep it 1 whitelist spot per wallet/twitter account.</p>
                    </div>
                </AccordionItemPanel>
            </AccordionItem>
            <AccordionItem className="mt-4 mb-8">
                ...
                <AccordionItemPanel>
                    <div className=" rounded-lg text-black pl-12 pt-4 pb-4">
                        <p className="text-lg md:text-xl">500 total </p>
                    </div>
                </AccordionItemPanel>
            </AccordionItem>
            <AccordionItem className="mt-4 mb-8">
                ...
                <AccordionItemPanel>
                    <div className=" rounded-lg text-black pl-12 pt-4 pb-4">
                        <p className="text-lg md:text-xl">Simple - COST,  stage 2 and stage 3 will cost more to join. Get in early!</p>
                    </div>
                </AccordionItemPanel>
            </AccordionItem>
        </Accordion>
